...
public class faltoro extends JComponent implements ActionListener, MouseMotionListener, KeyListener  {
	
	//public static Dimension dimension = new Dimension(1024,768); // Ablak fix méretének beállítása
	
	// Változók inicializálása 
	public int state = 0;
	public int labda_sebesseg_x = 2;
	public int labda_sebesseg_y = 2;
	public int labda_poz_x = 150;
	public int labda_poz_y = 300;
	public int labda_size = 24;
	public int uto_size_x = 150;
	public int uto_size_y = 20;
	public int uto_poz = 0;
